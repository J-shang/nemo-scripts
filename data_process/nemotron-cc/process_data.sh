...
TOKENIZER_MODEL=${TOKENIZER_MODEL:-"openai/gpt-oss-120b"}

OUTPUT_PREFIX=${OUTPUT_PREFIX:-"/data/nishang/data/${TOKENIZER_MODEL}/Nemotron-CC-MergeShard"}
MFORMAT_PREFIX=${MFORMAT_PREFIX:-"/data/nishang/data/${TOKENIZER_MODEL}/Nemotron-CC-MFormat"}
